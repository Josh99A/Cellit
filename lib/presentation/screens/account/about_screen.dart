            ...
            children: [
              ...
              Align(
                ...
                child: GestureDetector(
                  ...
                  onTap: () {
                    ExternalLauncher.openUrl('https://github.com/Josh99A');
                  },
                ),
              ),
              ...
              Align(
                ...
                child: GestureDetector(
                  child: Row(
                    ...
                    children: [
                      Text(
                        "Based on flutter_pos by Elriz Wiraswara (MIT)",
                        textAlign: TextAlign.justify,
                        style: Theme.of(context).textTheme.labelSmall?.copyWith(
                          color: Theme.of(context).colorScheme.primary,
                          fontWeight: FontWeight.bold,
                  ...
                  onTap: () {
                    ExternalLauncher.openUrl('https://github.com/elrizwiraswara/flutter_pos');
                  },
                ),
              ),
            ],
