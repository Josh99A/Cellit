...
// in cellit/test/domain/usecases/storage_usecases_test.dart.
...
import 'package:cellit/domain/repositories/storage_repository.dart' as _i2;
...
class MockStorageRepository extends _i1.Mock implements _i2.StorageRepository {
  ...
  @override
  _i3.Future<_i4.Result<void>> queueProductImageUpload(
    int? productId,
    String? imagePath,
  ) =>
      (super.noSuchMethod(
            Invocation.method(#queueProductImageUpload, [productId, imagePath]),
            returnValue: _i3.Future<_i4.Result<void>>.value(
              _i5.dummyValue<_i4.Result<void>>(
                this,
                Invocation.method(#queueProductImageUpload, [
                  productId,
                  imagePath,
                ]),
              ),
  ...
  @override
  _i3.Future<_i4.Result<void>> queueUserPhotoUpload(
    String? userId,
    String? imagePath,
  ) =>
      (super.noSuchMethod(
            Invocation.method(#queueUserPhotoUpload, [userId, imagePath]),
            returnValue: _i3.Future<_i4.Result<void>>.value(
              _i5.dummyValue<_i4.Result<void>>(
                this,
                Invocation.method(#queueUserPhotoUpload, [userId, imagePath]),
