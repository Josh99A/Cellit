...
import 'package:cellit/app/di/app_providers.dart';
import 'package:cellit/app/routes/app_routes.dart';
import 'package:cellit/domain/entities/user_entity.dart' hide AuthProvider;
import 'package:cellit/presentation/providers/auth/auth_notifier.dart';
import 'package:cellit/presentation/providers/auth/auth_state.dart';
import 'package:cellit/presentation/providers/main/main_notifier.dart';
import 'package:cellit/presentation/providers/main/main_state.dart';
...
void main() {
  ...
  group('SignInScreen Widget Tests', () {
    testWidgets('should display all UI elements', (tester) async {
      ...
      expect(find.text('Welcome to Cellit'), findsOneWidget);
